...
import N from '../../assets/letra_netflix.png'
import './Navbar.css'
  ...
  return (
    ...
    <div className="toda_navbar">
      ...
      <div className="netflix_logo">
        ...
        <Link to="/Browser" style={{ textDecoration: 'none' }}><img src={N} alt="" className='N' /></Link>

    </div><div className="navegacoes">
      ...
      </div><div className="last_section">
